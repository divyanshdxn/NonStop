import  {Categorycard, CategoryItem, Eventcard, EventItem } from './home/categories'
...
const eventDetails: EventItem[] = [{
  imageurl: 'https://d8it4huxumps7.cloudfront.net/uploads/images/opportunity/mobile_banner/6438043976529_unstop-ipl-cluekeepers.jpg?d=413x236',
...
export default function Home() {
    return(
      <div className='flex flex-col w-full items-center'>
        ...
        <div className='flex w-9/12 flex-wrap p-6 m-5 justify-center'>
        ...
        <div className='flex w-9/12 flex-wrap p-3 justify-center bg-gray-900 rounded-3xl '>
          <div className='flex w-9/12 flex-wrap p-6 m-3'>
